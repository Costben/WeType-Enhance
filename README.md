...
| 按键手势 | 全键盘与九宫格下滑手势、25 种动作绑定、触觉反馈与角标 |
...
- 候选词背景透明度与圆角
- 首个候选词左边距、候选栏拼音左边距
- 系统底栏图标跟随输入法背景自动反色（深底白图标 / 浅底深图标，按背景实际亮度判定）

### 按键手势

- QWERTY 全键盘与九宫格 T9 两条手势通道，独立开关
- 内置 25 种下滑动作：全选、剪切、复制、粘贴、全复制、全剪切、撤销、重做、段首、段尾、选至段首、选至段尾、文首、文尾、选至文首、选至文尾、剪切板、常用语、手写找字、输入法设置、滑移、滑选、禁用下滑、未绑定、模块设置
